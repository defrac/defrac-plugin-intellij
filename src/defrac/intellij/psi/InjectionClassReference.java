 ...
 *
 */
public final class InjectionClassReference extends ClassReferenceBase {
  @NotNull
  private static final Logger LOG = Logger.getInstance(InjectionClassReference.class.getName());
  ...
  @Nullable
  @Contract("null -> null")
  public static InjectionClassReference getInstance(@Nullable final PsiAnnotation annotation) {
    if(!isInjectAnnotation(annotation)) {
      return null;
    }

    return findReference(annotation, InjectionClassReference.class);
  }

  public InjectionClassReference(@NotNull final String value,
