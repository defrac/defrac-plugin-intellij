 ...
 *
 */
public final class DefracPackageTask extends DefracCompilerTask {
  @NotNull @NonNls private static final String NAME = "package";

  @NotNull
  public static final DefracPackageTask INSTANCE = new DefracPackageTask();

  private DefracPackageTask() {
  }
